  ...
  return (
    ...
    >
      ...
      <div className="section-padding relative">
        <div className="mx-auto grid min-w-0 max-w-6xl items-center gap-10 lg:grid-cols-2 lg:gap-20">
          <div className="relative min-w-0 lg:order-none">
            <div className="pointer-events-none absolute -inset-4 hidden rounded-[2.35rem] bg-gradient-to-br from-[var(--accent-mid)]/[0.14] via-transparent to-indigo-500/10 blur-2xl sm:block" />
            <div className="pointer-events-none absolute -inset-px hidden rounded-[2.05rem] bg-gradient-to-br from-white via-transparent to-[var(--accent-soft)] opacity-90 sm:block" />

            <div className="relative">
              <div className="relative aspect-[4/3] min-h-[15rem] w-full overflow-hidden rounded-[1.5rem] bg-slate-200 shadow-[var(--shadow-soft)] ring-2 ring-white sm:aspect-[4/5] sm:min-h-0 sm:rounded-[2rem] sm:ring-[3px] lg:aspect-[3/4]">
                <Image
                ...
                <div className="pointer-events-none absolute inset-x-0 top-0 h-20 bg-gradient-to-b from-white/20 to-transparent sm:h-24 sm:from-white/25" />
              </div>
            </div>
          </div>

          <div className="relative min-w-0 lg:pb-4">
            <div className="relative">
              ...
              <p className="font-display text-xs font-semibold uppercase tracking-[0.14em] text-[var(--muted)]">
                {aboutSeoCopy.eyebrow}
              </p>
              <h2 className="mt-3 text-3xl font-semibold tracking-tight text-[var(--heading)] md:text-[2.15rem] md:leading-tight">
                {aboutSeoCopy.title}
              </h2>
            </div>
